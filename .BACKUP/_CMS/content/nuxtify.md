---
title: FROM NEW DIR My Quest For the Ultimate Nuxt.js Wesbite Template
...
:dog: I've spent the past several months working with Nuxt and trying to compose an awesome starter template to use.
